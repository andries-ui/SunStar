    ...
    return (
        <View style={{ paddingHorizontal: 50, backgroundColor: theme.background, height: '100%', justifyContent: 'center', alignItems: 'center' }} >
            ...
            <Text style={{ textAlign: 'center', color: theme.text, fontSize: Constance.x_small, marginTop: 30 }}>You have booked
                <Text style={{ textAlign: 'center', color: theme.text, fontSize: Constance.small, fontWeight: 'bold' }}> Garden suit </Text> at
                <Text style={{ textAlign: 'center', color: theme.text, fontSize: Constance.small, fontWeight: 'bold' }}> Gardens hotel for 3 days </Text></Text>

            <Text style={{ marginTop: 10, textAlign: 'center', color: theme.text, fontSize: Constance.x_small }}>check in date-time:
                <Text style={{ textAlign: 'center', color: theme.text, fontSize: Constance.small, marginTop: 10, fontWeight: 'bold' }}>13/03/2021 12:00 </Text>
            </Text>

            <Text style={{ textAlign: 'center', color: theme.text, fontSize: Constance.x_small }}>check out date-time:
                <Text style={{ textAlign: 'center', color: theme.text, fontSize: Constance.small, marginTop: 10, fontWeight: 'bold' }}>13/03/2021 12:00
                </Text>
            </Text>
